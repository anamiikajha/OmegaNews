        ...
        <div>
          ...
          <div className="my-4 mx-3 container-lg">
            <h5 className="text-2xl my-2 font-bold tracking-tight text-gray-900 ">
              Omega News is the ultimate source for news
            </h5>
            ...
            <p className="font-normal my-2 text-gray-700">
              Omega News is a great source for news. It has everything you
          ...
          <div className="my-4 mx-3 container-lg">
            ...
            <a href="https://github.com/anamiikajha/OmegaNews-React">
              <svg
