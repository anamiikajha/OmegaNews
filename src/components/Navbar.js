      ...
      <header className="sticky">
        ...
        <div className="container flex flex-wrap justify-between items-center mx-auto">
          <span className="flex items-center">
            ...
            <img src="logo192.png" className="mr-3 h-7 sm:h-9" alt="Omega Logo" />
            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Omega News</span>
            </Link>
            </span>
          </span>
